    ...
    const drawGrid = () => {
      ...
      for (let x = startX; x < canvas.width + squareSize; x += squareSize) {
        for (let y = startY; y < canvas.height + squareSize; y += squareSize) {
          ...
          // Hover detection using the actual drawn square position
          const drawnGridX = Math.floor((x - startX) / squareSize);
          const drawnGridY = Math.floor((y - startY) / squareSize);

          if (
            hoveredSquareRef.current &&
            drawnGridX === hoveredSquareRef.current.x &&
            drawnGridY === hoveredSquareRef.current.y
          ) {
